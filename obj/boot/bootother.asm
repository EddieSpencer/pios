...
start:
    ...
    1003:	8e d8                	movl   %eax,%ds
	movw    %ax,%es             # -> Extra Segment
    1005:	8e c0                	movl   %eax,%es
	movw    %ax,%ss             # -> Stack Segment
    1007:	8e d0                	movl   %eax,%ss
...
start32:
    ...
    1021:	8e d8                	movl   %eax,%ds
	movw    %ax, %es                # -> ES: Extra Segment
    1023:	8e c0                	movl   %eax,%es
	movw    %ax, %ss                # -> SS: Stack Segment
    1025:	8e d0                	movl   %eax,%ss
	movw    $0, %ax                 # Zero segments not ready for use
    1027:	66 b8 00 00          	mov    $0x0,%ax
	movw    %ax, %fs                # -> FS
    102b:	8e e0                	movl   %eax,%fs
	movw    %ax, %gs                # -> GS
    102d:	8e e8                	movl   %eax,%gs
